...
| Reconciliation | Stale overwrite, partial-snapshot deletion, or cross-provider takeover | Immutable exact plans, configuration revisions, optimistic target revisions, completeness flags, explicit conflicts, local ownership claims, and durable idempotency |
