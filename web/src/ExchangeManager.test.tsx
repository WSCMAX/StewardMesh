...
test('renders selectable records and visible holding outcomes accessibly on a narrow-safe surface', async () => {
  ...
  expect(screen.getByRole('region', { name: 'Portable records' })).toHaveClass('overflow-auto')
  expect(screen.getByRole('region', { name: 'Outcomes for package package-import' })).toHaveClass('overflow-auto')
