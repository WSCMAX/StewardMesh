...
export type GuideTopicID = 'workspace' | 'atlas' | 'horizon' | 'ledger' | 'stack' | 'signals' | 'reach' | 'threads' | 'vault' | 'exchange' | 'people' | 'mesh' | 'bridge' | 'guard' | 'guide'
...
export const walkthroughTopicIDs: readonly GuideTopicID[] = ['workspace', 'atlas', 'signals', 'people']

export const guideTopics: GuideTopic[] = [
  { id: 'workspace', name: 'Workspace', descriptor: 'Connected work view', summary: 'Use the sidebar to open one area at a time. Your filters and unfinished work stay in place when you switch.', example: 'Open Inventory, filter to active desktops, then return here from Overview without losing that filter.', docsUrl: documentationHref('workspace'), anchor: 'main-content' },
  { id: 'atlas', name: 'Atlas', descriptor: 'Asset inventory', summary: 'Search and inspect assets, then double-click a row to open its record and lifecycle history.', example: 'Find a lab station, open its detail drawer, and review who uses it from the Mesh graph.', docsUrl: documentationHref('atlas'), anchor: 'guide-atlas', permission: 'assets.read' },
  { id: 'horizon', name: 'Horizon', descriptor: 'Lifecycle planning', summary: 'Set effective-dated asset replacement assumptions, compare planning scenarios, and forecast needs using Atlas inventory, Ledger costs, and tag dimensions.', example: 'Plan a server refresh, then group replacement needs by fiscal year, site, department, effective tag, linked goal, or asset class.', docsUrl: documentationHref('horizon'), anchor: 'guide-horizon', permission: 'planning.read' },
  ...
  { id: 'signals', name: 'Signals', descriptor: 'Alerts and action queue', summary: 'Evaluate enabled rules, then acknowledge or assign alerts that need attention.', example: 'Press Evaluate now, open the first active alert, and assign it to the right group.', docsUrl: documentationHref('signals'), anchor: 'guide-signals', permission: 'signals.read' },
  ...
  { id: 'people', name: 'People', descriptor: 'Users and departments', summary: 'Browse identities by department, then double-click a row to inspect a person or shared account.', example: 'Group the directory by department, open one identity, and confirm their site and room assignment.', docsUrl: documentationHref('people'), anchor: 'guide-people', permission: 'directory.read' },
  { id: 'mesh', name: 'Mesh', descriptor: 'Cross-product graph', summary: 'Explore how people, assets, purchase orders, tags, licenses, goals, documents, and plans connect in one graph and table.', example: 'Show purchase orders and tags, cluster vendors, then switch to the data table to sort the same records.', docsUrl: documentationHref('mesh'), anchor: 'guide-mesh', permissions: ['directory.read', 'assets.read', 'finance.read', 'software.read', 'labels.read', 'goals.read', 'storage.read', 'planning.read'] },
