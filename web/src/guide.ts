...
// Requirements: REQ-WORKSPACE-001, REQ-HORIZON-001, REQ-STACK-001, REQ-SIGNALS-001, REQ-EXCHANGE-001, A11Y-001, DOC-001, DOC-002. Features: experience.workspace, lifecycle.planning, software.licenses, alerts.rules, migration.packages, experience.help.

export type GuideTopicID = 'workspace' | 'atlas' | 'horizon' | 'ledger' | 'stack' | 'signals' | 'threads' | 'vault' | 'exchange' | 'people' | 'guard' | 'guide'
