...
// Requirements: REQ-WORKSPACE-001, REQ-HORIZON-001, REQ-STACK-001, A11Y-001, DOC-001, DOC-002. Features: experience.workspace, lifecycle.planning, software.licenses, experience.help.

export type GuideTopicID = 'workspace' | 'atlas' | 'horizon' | 'ledger' | 'stack' | 'threads' | 'vault' | 'people' | 'guard' | 'guide'
