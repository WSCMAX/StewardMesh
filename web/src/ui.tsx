...
export const inputClass = 'mt-1.5 min-h-11 w-full rounded-md border-0 bg-steward-ink-950 px-3 py-2 text-base text-steward-mist ring-1 ring-inset ring-white/10 transition placeholder:text-steward-slate hover:ring-white/18 focus:ring-2 focus:ring-inset focus:ring-steward-teal disabled:cursor-not-allowed disabled:opacity-55 sm:text-sm'
export const compactInputClass = 'min-h-10 min-w-0 rounded-md border-0 bg-steward-ink-950 px-2.5 py-1.5 text-sm text-steward-mist ring-1 ring-inset ring-white/10 transition hover:ring-white/18 focus:ring-2 focus:ring-inset focus:ring-steward-teal disabled:cursor-not-allowed disabled:opacity-55'
export const labelClass = 'block text-sm font-medium text-steward-mist'
export const buttonClass = 'inline-flex min-h-11 items-center justify-center gap-2 rounded-md border border-transparent bg-steward-teal px-3.5 py-2 text-sm font-semibold text-steward-ink-950 transition hover:bg-[#35d2bd] disabled:cursor-wait disabled:opacity-55'
export const secondaryButtonClass = 'inline-flex min-h-11 items-center justify-center gap-2 rounded-md border border-white/12 bg-transparent px-3.5 py-2 text-sm font-medium text-steward-mist transition hover:border-white/20 hover:bg-white/[0.04] disabled:cursor-not-allowed disabled:opacity-50'
...
export const plainButtonClass = 'inline-flex min-h-11 items-center justify-center gap-2 rounded-md px-2.5 py-2 text-sm font-medium text-steward-teal transition hover:bg-steward-teal/10 hover:text-[#5be0cc] disabled:opacity-50'
...
export const gridActionButtonClass = 'inline-flex min-h-6 shrink-0 items-center justify-center rounded-md px-1.5 text-xs font-medium text-steward-teal transition hover:bg-steward-teal/10 hover:text-[#5be0cc] disabled:opacity-50'
